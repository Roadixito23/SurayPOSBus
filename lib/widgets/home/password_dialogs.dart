                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide:
                          BorderSide(color: Colors.yellow.shade300, width: 2),
                    ),
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12),
                      borderSide:
                          BorderSide(color: Colors.yellow.shade500, width: 2),
                    ),
                    helperText: 'Máximo 6 dígitos',
                    prefixIcon:
                        Icon(Icons.password, color: Colors.yellow.shade500),
                    filled: true,
                            ...
                            NfcManager.instance.startSession(
                              ...
                              onDiscovered: (NfcTag tag) async {
                                ...
                                if (tagId != null) {
                                  ...
                                  final cardsJson =
                                      prefs.getString('linked_nfc_cards') ??
                                          '[]';
                                  final List<String> authorizedIds =
                                      List<String>.from(json.decode(cardsJson));

                                  final bool isAuthorized =
                                      authorizedIds.isEmpty ||
                                          authorizedIds.contains(tagIdHex);
...
Future<void> showPasswordDialog(
  ...
  if (hasAnulado) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            'Ya se ha anulado una venta. Genere un nuevo boleto para poder anular de nuevo.'),
      ),
    );
    return;
  }
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    helperText: 'Máximo 6 dígitos',
                    prefixIcon:
                        Icon(Icons.password, color: Colors.red.shade500),
                    filled: true,
